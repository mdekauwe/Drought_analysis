...
def main(fname, plot_dir):
    ...
    cmap = plt.cm.get_cmap('viridis', 8) # discrete colour map
    ...
    for i, ax in enumerate(axgr):
        ...
        plims = plot_map(ax, ds.iveg[:,:],cmap, i)


    cbar = axgr.cbar_axes[0].colorbar(plims)
    cbar.ax.set_title("iveg", fontsize=16)

    ofname = os.path.join(plot_dir, "iveg.png")
