...
def main(plot_dir):
    ...
    ax.plot(dates, fw_wsf_all, label="WSF", color=colours[2], lw=2)

    ax.fill_between(dates, fw_wsf_all+fw_wsf_sigma, fw_wsf_all-fw_wsf_sigma,
    ...
    #plt.savefig(os.path.join(odir, "vwc_WSF_timeseries_control.pdf"),
